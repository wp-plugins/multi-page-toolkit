...
Quick jump options include dropdown menu using page numbers or page titles.
...
** To use TA_content_jump **
	...
	$quick_type = 1		(quick jump navigation type 0 = disable ,1 = Drop Down List ,2 = page number links) 
	...
	$nav_number = TRUE	(only used when nav_type = 1, if TRUE [age titles preceeded by page number)
